...
echo "<br>".$arrayp['prodDescripLong']."<br>";
echo "<br><b> $ ".$arrayp['prodPrice']."</b><br>";
echo "<br><b> Left in Stock: ".$arrayp['prodQuantity']."</b></p>";
...
//name='submitbtn'
echo "<input type=submit  value='ADD TO BASKET' id='submitbtn' name='addToBasket'>";
